...
class message(Model):
    ...
    def __init__(self, message_id, message_text, sent_by_id, parent_conversation_id, datetime_sent, username): #self always points to the actual object instance this case being conversation
